...
const SpinnerLoader = () => {
  return (
    <div role="status" className="flex justify-center items-center py-5">
      <svg
        aria-hidden="true"
        className="w-5 h-5 animate-spin text-gray-200 fill-orange-500"
        viewBox="0 0 100 101"
        fill="none"
      ...
      >
        <path
          ...
          50.5908C9.08144 73.1865 27.4043 
          91.5094 50 91.5094C72.5957 91.5094 
          90.9186 73.1865 90.9186 
          50.5908C90.9186 27.9951 72.5957 
          9.67226 50 9.67226C27.4043 
          9.67226 9.08144 27.9951 
          9.08144 50.5908Z"
          fill="currentColor"
        />
